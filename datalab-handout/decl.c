...
// Bit manipulations (rating sum 15)
 ...
 {"grayToBinary", (funct_t) grayToBinary, (funct_t) test_grayToBinary, 1,
    "^ >>", 20, 3,
...
// Two's complement arithmetic (rating sum 17)
 ...
 {"absVal", (funct_t) absVal, (funct_t) test_absVal, 1, "! ~ & ^ | + << >>", 10, 4,
  {{-TMax, TMax},{TMin,TMax},{TMin,TMax}}},
 {"satSub", (funct_t) satSub, (funct_t) test_satSub, 2,
    "! ~ & ^ | + << >>", 30, 4,
  {{TMin, TMax},{TMin,TMax},{TMin,TMax}}},
// Floating point (rating sum 16)
 ...
 {"float_negpwr2", (funct_t) float_negpwr2, (funct_t) test_float_negpwr2, 1,
    "$", 20, 4,
     {{1, 1},{1,1},{1,1}}},
 {"float_greater", (funct_t) float_greater, (funct_t) test_float_greater, 2,
    "$", 45, 4,
     {{1, 1},{1,1},{1,1}}},
  {"", NULL, NULL, 0, "", 0, 0,
   {{0, 0},{0,0},{0,0}}}
